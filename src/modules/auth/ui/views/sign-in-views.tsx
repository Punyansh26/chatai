                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col justify-center p-4 md:p-10">
                                <FieldGroup>
                                    ...
                                    <div className="mb-2 flex flex-col items-center gap-4 text-center">
                                        <div>
                                            ...
                                            <p className="mt-1.5 text-sm text-purple-100/60">
                                                Sign in to your Chat AI account
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                ...
                                                <a href="#" className="ml-auto text-xs text-purple-400/70 underline-offset-2 transition-colors duration-200 hover:text-purple-300 hover:underline">
                                                    Forgot password?
                                                </a>
                                                <FormControl>
                                                    <Input
                                    ...
                                    <FieldDescription className="text-center text-xs text-purple-100/60">
                                        ...
                                        <Link href="/sign-up" className="font-medium text-purple-100 underline-offset-2 transition-colors duration-200 hover:text-purple-100 hover:underline">
                                            Sign up for free
                                        </Link>
                                    </FieldDescription>
